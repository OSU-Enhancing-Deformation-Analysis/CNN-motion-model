...
class UNetMotionVectorRegressionNetwork(nn.Module):
...
model = UNetMotionVectorRegressionNetwork(input_images=2).to(device)
print(model)
...
wandb_config = {
    ...
    "architecture": "UNetMotionVectorRegressionNetwork",
    "dataset": {
